...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!oflc_church_year_is_valid_range($options, $startKey, $endKey)) {
        ...
        header('Location: church-year.php?saved=1');
        exit;
    }
...
<div class="church-year-page">
    ...
    <?php if ($savedMessage): ?>
        <p class="church-year-message church-year-message-success">Church year settings were saved.</p>
    <?php endif; ?>
    ...
    <form method="post" action="church-year.php" class="church-year-form" id="church-year-form">
